...
%% Additional columns- lydia
heading_deg = textRaw{2};
groundspeed_kt = textRaw{3};
altRate_fps = textRaw{7};
airspaceClass = textRaw{10};
% airspaceName = textRaw{11};
% heading_deg,groundspeed_kt, altRate_fps, airspaceClass,

% Assign to output timetable
VariableNames = {'lat_deg','lon_deg','alt_ft_msl','alt_ft_agl','heading_deg', 'groundspeed_kt', 'altRate_fps', 'airspaceClass'};
TTout = timetable(lat_deg,lon_deg,alt_ft_msl,alt_ft_agl,heading_deg,groundspeed_kt,altRate_fps,airspaceClass,'VariableNames',VariableNames,'RowTimes',rowTimes);
