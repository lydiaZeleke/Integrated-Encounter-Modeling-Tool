...
%
% SEE ALSO timetable encounterGeneration sampleSpeedAlt
...
% assert(trackIn.Properties.TimeStep == seconds(0.1),'Input timetable timestep expected to be 0.1 sec, it was not');
...
%         trackOut = retime(trackOut,'regular','pchip', 'Timestep', seconds(0.1));
